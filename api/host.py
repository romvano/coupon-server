...
from models import DB_UID, LATITUDE, LONGITUDE, OFFER, LOYALITY_TIME_PARAM, LOYALITY_BURN_PARAM, NO_BURN
...
def update_loyality():
    ...
    loyality_burn = NO_BURN if data.get(LOYALITY_BURN_PARAM) is None else int(data[LOYALITY_BURN_PARAM])
